  ...
  const customerReviews = [
    {
      ...
      review: 'I did a 10-day Post Natal treatment at Namaste Ayurveda Hospital, and it was a great experience. My therapist Ms Sanila was very gentle ,caring and made sure I was comfortable through every session and Dr. Joselin guided me perfectly throughout the treatment. I felt relaxed, supported, and truly benefited from the sessions. Highly recommended! Thank you Team Namaste♥️',
      rating: 5,
      date: 'a month ago',
      verified: true
    },
    {
      ...
      review: 'Namaste Ayurveda at Mampoyil is truly a hidden gem for anyone seeking authentic Ayurvedic care in a serene and rejuvenating setting. The atmosphere is peaceful and closely connected to nature — the perfect place to unwind, heal, and recharge. The staff are highly professional, warm, and attentive. The doctors take the time to thoroughly understand your health concerns and provide personalized treatments with genuine care. The therapies are traditional, effective, and delivered with exceptional attention to detail.',
      rating: 5,
      date: '1 week ago',
      verified: true
    },
    {
      id: 3,
      name: 'Muhammad Anfad Km',
      location: 'Malappuram, Kerala',
      initial: 'M',
      avatarColor: 'bg-green-500',
      review: 'I came here suffering from neck pain, without believing that Ayurveda would help. I had already consulted allopathic doctors and taken medicines, but there was no improvement—so I came here. The doctor here completely cured it within just two weeks. I never imagined this place would be this amazing, not even in my dreams.',
      rating: 5,
      date: 'a month ago',
      verified: true
    },
    {
      ...
      review: 'We recently visited Namaste Ayurveda for my family’s postnatal care, and the experience was nothing short of excellent. Despite our time constraints, we opted for the 7-day package, which covered a range of treatments, including various oil massages, facial massages, and different types of kizhi. Every treatment was rejuvenating and well-executed. I also took a separate 3-day package that included a full-body massage and steam bath, which was equally superb. Namaste Ayurveda offers a variety of services, such as general medicine, cosmetology, panchakarma, agnikarma, prenatal and postnatal care. They even have different types of rooms available if you would like to stay with your family, complete with homely meals. The staff are well-trained and provide excellent service, making the experience even more pleasant. I highly recommend this place for anyone seeking authentic Ayurvedic care.',
      rating: 5,
      date: '3 weeks ago',
      verified: true
    }
